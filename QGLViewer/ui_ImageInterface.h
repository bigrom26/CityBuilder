...
public:
    ...
    void setupUi(QDialog *ImageInterface)
    {
        if (ImageInterface->objectName().isEmpty())
            ImageInterface->setObjectName(QLatin1String("ImageInterface"));
        ...
        imgWidth->setObjectName(QLatin1String("imgWidth"));
        ...
        imgHeight->setObjectName(QLatin1String("imgHeight"));
        ...
        imgQuality->setObjectName(QLatin1String("imgQuality"));
        ...
        hboxLayout2->setObjectName(QLatin1String("hboxLayout2"));
        ...
        oversampling->setObjectName(QLatin1String("oversampling"));
        ...
        whiteBackground->setObjectName(QLatin1String("whiteBackground"));

        vboxLayout->addWidget(whiteBackground);

        expandFrustum = new QCheckBox(ImageInterface);
        expandFrustum->setObjectName(QLatin1String("expandFrustum"));
        ...
        hboxLayout3->setObjectName(QLatin1String("hboxLayout3"));
